(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('date-fns/format'), require('date-fns/distance_in_words_to_now'), require('numeral')) :
	typeof define === 'function' && define.amd ? define(['date-fns/format', 'date-fns/distance_in_words_to_now', 'numeral'], factory) :
	(global.sifter = factory(global.format,global.distanceInWordsToNow,global.numeral));
}(this, (function (format,distanceInWordsToNow,numeral) { 'use strict';
...
var slugify = function (val) {
  return kebabCase_1(deburr_1(val))
};
